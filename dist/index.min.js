...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__uppy_core_lib_BasePlugin_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__uppy_core_lib_BasePlugin_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__uppy_core_lib_BasePlugin_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_spark_md5__ = __webpack_require__(2);
...
const stDefaultOptions = {
     ...
     */
};class SuperTrans extends __WEBPACK_IMPORTED_MODULE_0__uppy_core_lib_BasePlugin_js__["default"] {
    constructor(uppy, opts) {
        ...
        this.prepareUpload = fileIDs => {
            const promises = fileIDs.map(fileID => {
                ...
                return this.computeMd5(file).then(this.getFileInfoByMd5).then(fileInfo => this.uploadFileByMd5(fileInfo, file.name)).then(fileInfo => {
            ...
            return new Promise((resolve, reject) => {
                if (fileInfo && fileInfo.fingerprint) {
                    fetch(this.opts.gateway + this.opts.md5UploadEndpoint, {
                        ...
                        body: "file_name=" + encodeURIComponent(fileName) + "&fingerprint=" + fileInfo.fingerprint + "&tenant_id=" + this.uppy.getState().meta.tenant_id + "&user_id=" + this.uppy.getState().meta.user_id + "&relation_type=" + this.uppy.getState().meta.relation_type + "&relation_target=" + this.uppy.getState().meta.relation_target + "&app_name=" + this.uppy.getState().meta.app_name
        ...
        this.computeMd5 = selectedFile => {
            return new Promise((resolve, reject) => {
                ...
                let currentChunk = 0;
                let spark = new __WEBPACK_IMPORTED_MODULE_1_spark_md5___default.a.ArrayBuffer();
...
/* harmony export (immutable) */ __webpack_exports__["default"] = SuperTrans;
...
throw new Error("Module parse failed: Unexpected token (33:17)\nYou may need an appropriate loader to handle this file type.\n|     } = this.uppy.getState();\n|     this.uppy.setState({\n|       plugins: { ...plugins,\n|         [this.id]: { ...plugins[this.id],\n|           ...update");
